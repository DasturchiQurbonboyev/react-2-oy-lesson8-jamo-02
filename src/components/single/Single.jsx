                ...
                <div className="grid grid-cols-2 items-start gap-16 mx-auto max-md:px-2 ">
                    ...
                    <div
                        ...
                        <div className="data w-full max-w-xl">
                            <h2 className="font-manrope font-bold text-[24px] leading-10 text-gray-900  capitalize">{single.title}</h2>
                            <div className="flex flex-col sm:flex-row sm:items-center ">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="pl-2 font-normal leading-7 text-gray-500 text-sm ">({single.rating} Reviews)</span>
                            ...
                            <div className="flex gap-3 py-8">
                                ...
                                <button className="outline-none  text-center w-full px-5 py-4 rounded-[100px] bg-indigo-600 flex items-center justify-center font-semibold text-lg text-white shadow-sm transition-all duration-500 hover:bg-indigo-700 hover:shadow-indigo-400"> Buy Now </button>
                                <button onClick={() => dispatch(toggleWishes(single))} className="outline-none  group transition-all duration-500 p-4 rounded-full bg-indigo-50 hover:bg-indigo-100 hover:shadow-sm hover:shadow-indigo-300">
                                    {wishes.some(w => w.id === single.id) ?
                                        <FaHeart onClick={() => toast.error("Wishlistdan o'chirildi")} size={25} className="text-[red]" /> :
                                        <FaHeart onClick={() => toast.success("Wishlistga qo'shildi")} size={25} className="" />}
                                </button>
                            </div>
